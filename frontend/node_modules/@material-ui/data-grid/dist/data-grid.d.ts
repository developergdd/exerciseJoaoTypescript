...
declare type DataGridProps = Omit<GridComponentProps, 'disableColumnResize' | 'disableMultipleColumnsSorting' | 'disableMultipleSelection' | 'licenseStatus' | 'apiRef' | 'options' | 'pagination'> & {
